...
<div className='flex border-2 w-11/12 border-gray-200 m-8'>
    <div className='flex flex-col gap-2 w-2/12 border-r-2 border-gray-200'>
      ...
      {showCardForm && (
        <div className='ml-8'>
            ...
            <div className='m-6'>
                <TextInput placeholder='Card Secreet' className=' text-lg text-gray-400'></TextInput>
                <hr className='border-1 border-gray-400'/>
            </div>

            <div className="ml-4 mt-40 mb-4 flex flex-col md:flex-row gap-8">
                <Link to='/cart'>
                ...
                <Button className="text-white font-bold text-xl h-14 w-72 bg-blue-500 rounded">
